...
//		try {
//			if (sendMessage("ptnpql95t17d122m@studenti.unical.it", "fattura", "compa"))
...
//	}
	...
	public static boolean sendMessage(String send, String object, String messageArea, String pdf, boolean allegato)
		...
		if (result) {
			...
			// mittente
			message.setFrom(new InternetAddress("unicaldelivery@gmail.com"));
			...
			// Send message
			sendEmail(message, session, "unicaldelivery@gmail.com");
